...
<html>
  <head>
    ...
    <title>Conducteurs | EtuCovoiturage</title>
...
<!-- barre de navigation -->
      ...
      <div class="content-wrapper">
        ...
        <!-- Tableau ui contiet la liste des conducteurs -->
        
<table class="table table-striped table-hover">
    <thead>
      <tr>
        <th>ID_conducteur</th>
        <th>Nom_conducteur</th>
        <th>Prenom_conducteur</th>
        <th>Sexe</th>
        <th>Date_naissance</th>
        <th>Numèro teléphone</th>
        <th>Consulter_conducteur</th>
      </tr>
    </thead>
    <tbody>
    <?php 
...
echo '<td>',$cond->id(),'</td>';
echo '<td>',$cond->nom(),'</td>';
echo '<td>',$cond->prenom(),'</td>';
echo '<td>',$cond->sexe(),'</td>';
echo '<td>',$cond->date_naissance(),'</td>';
echo '<td>',$cond->tel(),'</td>';
echo '<td style="text-align:center;"><a href="profil_conducteur.php?id='.$cond->id().'"><i style="color:blue;cursor:pointer;" class="fa fa-forward"></a></i></td>';
echo '</tr>';
}
