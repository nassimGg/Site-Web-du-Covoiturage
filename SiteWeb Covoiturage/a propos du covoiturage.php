...
<title>A propos du covoiturage | ETU Covoiturage</title>
...
<section id="section" style="height:500px;">
<div id="element">
	<ul>
		<li class="active"><a href="a propos du covoiturage.php">A propos du Covoiturage</a></li>
        <li><a href="comment ca marche.php">Comment ça marche ?</a></li>
        <li><a href="votre securite.php">Votre sécurité</a></li>
        <li><a href="contactez nous.php">Contactez nous</a></li>
        </ul>
</div>
<div id="element" style="margin-top:100px;margin-left:200px;margin-right:50px;margin-top:20px;">

<img src="images/apropos-covoiturage.png" style="border-radius:5px;margin-left:10px;"/>
<div style="margin-top:20px;border-top:1px solid gray;color:black;padding-left:15px;text-align:center;font-family:acme;font-size:19px;">
<p>
EtuCovoiturage.com est le premier site de covoiturage en Algerie . Créer en 2016 par Guergouri Nassim , EtuCovoiturage.com vous permet de poster  des offres et recherches de covoiturage .

Mais quesque le covoiturage ?

Le covoiturage est un moyen de transport qui permet aux personnes de partager une voiture pour aller d’un point A a un point B il est écologique , économique et agréable . Nous vous offrant donc la possibilité d’accédé a ce moyen de transport en postant des annonces gratuites sur notre site .

Plusieurs options sont misent a la disposition des membres pour détaillé leurs annonces et leurs recherches .
</p>
</div>
</div>
</section>
