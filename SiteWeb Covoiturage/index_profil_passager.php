...
<header id="header2">
  ...
  <nav>
    <ul id="navigation1">
      <li ><a style="cursor:pointer"href="logout.php?logout=true"><span id="main">Déconnecter</span></a></li>
      <li id="profilc"><a id="profilb" href="#"style="padding:5px;border-radius:5px;cursor:pointer;width:50%"><img src="profil_photo/<?php echo $participant->photo();?>" width="18px" height="18px" style="border-radius:100%;margin-right:3px;padding-top:px;display:inline-block;top:3px;position:relative;"/><span id="main"> <?php echo ucfirst($participant->prenom());?></span> <i id="carret"></i></a>
        <ul id="profilBox" style="list-style-type:none;">
          <div id="details_profil">
            ...
            <li style=""><a href="participant_reservation.php"style="cursor:pointer;color:inherit;">Vos réservations</a></li>
 ...
 <br> <br> <br> <br>
  <br> <br>
  <br>
  <div id="logo_recherche"><a href="#"><img src="images/rec.png" width="150px" height="100px" style="margin-top:-60px; margin-left:-15px;"/></a></div>
  <br>
  <div id="recherche1">
    <div id="contain_recherche1">
...
<form action="recherche_covoiturage_participant.php#section2" method="post" class="idealforms" id="form_recherche">
<div id="vil_dep"><br>
...
echo '<option value="', $vill,'">';
  ...
  <div id="vil_des"><br>
<input id="vde" type="text" required placeholder="Destination" style=" 
...
margin-left:30px;
    ...
    padding-bottom:5px;
    padding-left:30px;
    background-repeat: no-repeat;" list="villes" name="dest" autocomplete="on">
<datalist id="villes">
<?php foreach ($villes as $villee)
{$vill = utf8_encode($villee->nom_ville()); 
echo '<option value="', $vill,'">';
...
<section>
  <div id="annonce"><br>
    <br>
    <div id="logo_annonce"> <a href="#"><img src="images/annonce.png" width="150px" height="100px" /><br>
    </a></div>
...
<h1 style="margin-left:10px;">'.utf8_encode($managerville->getn($traj->num_ville2())).'</h1>
    ...
    display: flex;background-color:#33CCCC;border-radius:5px;padding-left:15px;width:100%;">
			...
			if(count($commentaires)>0) 
				...
				{$part=$manager->get($comm->id_participant()); echo ' 
...
<div id="dlgboxc'.$comm->id_commentaire().'">
    ...
    display: flex;">
	<form method="post" action="index_profil_participant.php" style=" margin-left:280px;">
...
<style>
  ...
  <form method="post" action="index_profil_participant.php?num='.$traj->num_trajet().'">
