...
<title>Comment ça marche | ETU Covoiturage</title>
...
<li><a href="a propos du covoiturage.php">A propos du Covoiturage</a></li>
        <li class="active"><a href="comment ca marche.php">Comment ça marche ?</a></li>
        <li><a href="votre securite.php">Votre sécurité</a></li>
...
<a onClick="show_rech()">
<li id="barre1" style="background-color:#0ca9fa;padding:10px;padding-top:10px;padding-right:120px; border-radius:5px 5px 0px 0px;padding-bottom:10px;cursor:default; color:white;" >
<span style="font-size:21px; font-weight:bold;">Vous êtes passager?</span><br>
<span style="font-size:17px; ">&#8250; Réservez une place</span>
</li>
</a>
<a onClick="show_ann()">
<li id="barre2" style="margin-left:5px;background-color:#EDDDED;padding:10px;padding-top:10px;padding-right:120px; border-radius:5px 5px 0px 0px;padding-bottom:10px; cursor:pointer;color:#0ca9fa;">
<span style="font-size:21px; font-weight:bold;">Vous êtes conducteur?</span><br>
<span style="">&#8250; Proposez vos places libres</span>
</li></a>
</ul>

<div id="recherche_content" style="margin-top:-16px;">
<p id="texte_recherche" style="width:41.6em; word-wrap: break-word;margin-left:40px;padding:9px; background-color:#0ca9fa;padding-top:20px;color:white;">Simple et économique : réservez facilement votre place en ligne et voyagez moins cher, en toute confiance.</p>
<img src="images/index.jpg" style="margin-left:40px; margin-top:-16px;width:683px;">
<ol style="margin-left:50px;margin-top:-30px; font-size:15px;">
<img src="images/search.png" width="30px" height="30px" style="margin-bottom:-55px;margin-left:-35px;">
<li>
<div id="left" style="">
<h4 style="font-size:18px;"><a style="cursor:pointer;"><span style="color:#0ca9fa;">Recherchez</span></a> votre trajet</h4>
<p style="margin-top:-25px;">Entrez vos villes de départ et de destination, ainsi que votre date de voyage et choisissez parmi les conducteurs proposant des trajets qui vous conviennent.</p>
</div>
<div id="right" style="float:right;margin-top:-135px;">
<p>Consultez le profil vérifié des conducteurs: photo, bio.
</p>
</div>
</li>
<img src="images/Ok.png" width="30px" height="30px" style="margin-bottom:-30px;margin-left:-35px;">
<li style="margin-top:-25px;">
<div id="left">
<h4 style="font-size:18px;">Réserver votre place</h4>
<p style="margin-top:-25px;">Vous réservez votre place en ligne.Votre conducteur est prévenu immédiatement de votre réservation par mail.Ensuite, appelez le conducteur pour régler les derniers détails du voyage de vive voix.
</p>
</div>
<div id="right" style="float:right;margin-top:-145px;">
<p>Bien sûr, si vous avez un empêchement, vous disposez votre annulation.</p>
</div>
</li>
<img src="images/icon-car.png" width="30px" height="30px" style="margin-bottom:-30px;margin-left:-35px;">
<li style="margin-top:-25px;">
<div id="left">
<h4 style="font-size:18px;">Voyager</h4>
<p style="margin-top:-25px;">Rendez-vous au lieu de départ convenu, bien à l'heure.<br>Bonne route !</p>
</div>
<div id="right" style="float:right;margin-top:-100px;">
<p>Après le voyage, laissez un avis à votre conducteur.</p>
</div>
</li>
</ol>
</div>
<div id="annonce_content" hidden="true" style="margin-top:-16px;">
<p id="texte_annonce" style="width:41.6em; word-wrap: break-word;margin-left:40px;padding:9px; background-color:#0ca9fa;padding-top:20px;color:#0ca9fa;">Économique et convivial : partagez vos frais en prenant des passagers sympas lors de vos longs trajets en voiture.</p>
<img src="images/illustration-driver.jpg" style="margin-left:40px; margin-top:-16px;width:683px;">
<ol style="margin-left:50px; margin-top:-30px">
<img src="images/icon-plus.png" width="30px" height="30px" style="margin-bottom:-55px;margin-left:-35px;">
<li>
<h4 style="font-size:18px;"><a style="cursor:pointer;"><span style="color:#0ca9fa;">Publier</span></a> votre annonce</h4>
<p style="margin-top:-20px;">Indiquez la date et l'horaire de votre trajet, l'itinéraire et le prix par passager.L'acceptations des passagers est automatique.En acceptation automatique, la confirmation est immédiate et vous n'avez rien à faire.</p>
</li>
<img src="images/Ok.png" width="30px" height="30px" style="margin-bottom:-30px;margin-left:-35px;">
<li style="margin-top:-25px;">
<h4 style="font-size:18px;">Vos passagers réservent leur places en ligne</h4>
<p style="margin-top:-20px;">Vos passagers réservent en ligne sur ETU Covoiturage et vous êtes automatiquement prévenu(e) par e-mail à chaque nouvelle réservation. Ensuite, échangez avec vos passagers par téléphone pour régler les derniers détails du voyage.
</p>
</li>
<img src="images/icon-car.png" width="30px" height="30px" style="margin-bottom:-30px;margin-left:-35px;">
<li style="margin-top:-25px;">
<h4 style="font-size:18px;">Voyager</h4>
<p style="margin-top:-20px;">Rendez-vous au lieu de départ convenu, bien à l'heure.<br>Bonne route !</p>
</li>
</ol>
