...
<div id="dlgboxc'.$comm->id_commentaire().'">
    ...
    display: flex;">
	<form method="post" action="recherche_covoiturage_participant.php" style=" margin-left:280px;">
...
<style>
  ...
  <form method="post" action="recherche_covoiturage_participant.php?num='.$traj->num_trajet().'">
