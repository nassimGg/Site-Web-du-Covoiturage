...
<title>Plan du Site | ETU Covoiturage</title>
...
<h1 style="text-align:center;font-size:32px;">Plan du Site</h1><br>
<img src="images/plansite.png" style="margin-left:50px;border-radius:5px;"/>
</section>
<?php
require "footer.php";
?>
