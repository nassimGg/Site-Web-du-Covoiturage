  ...
  <body class="hold-transition skin-purple sidebar-mini">
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview"><a href="#"><i class="fa fa-linkedin-square"></i> <span>Compte</span><i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
      ...
      <div class="content-wrapper">
        ...
        <!-- Form fermeture compte -->
<form method="post" action="participant_fermer_compte.php" class="form-horizontal" role="form">
...
<div id="dlgbox">
    ...
    display: flex;">
	<form method="post" action="participant_fermer_compte.php" style=" margin-left:280px;">
